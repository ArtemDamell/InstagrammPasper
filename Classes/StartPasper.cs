...
namespace InstagrammPasper.Classes
{
    ...
    {
        /// <summary>
        /// Starts the process of parsing data from the website using the Firefox web driver.
        /// </summary>
        /// <param name="resulTextBox">The text box to display the results.</param>
        ...
        /// <summary>
        /// Logs in to the user page, waits 4 seconds, clicks the login button, waits 4 seconds and checks the login success, waits 4 seconds and clicks the save button, and sets the DoneActionList.LoginIsDone to true.
        /// </summary>
        ...
        /// <summary>
        /// Starts the parsing process for a given web driver and text box. Clears the static array, navigates to the parsing page, finds the parent container, finds the current following link, clicks the link, scrolls to the bottom, parses the links and names, adds the data to the model, and sets the DoneActionList.StartParseIsDone flag to true.
        /// </summary>
        /// <param name="driver">The web driver.</param>
        /// <param name="resultTextBox">The text box.</param>
        ...
        // Save result to JSON
        /// <summary>
        /// Saves data to JSON file and quits the driver.
        /// </summary>
